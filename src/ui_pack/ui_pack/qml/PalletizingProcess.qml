                        ...
                        Column
                        {
                            ...
                            Row{
                                ...
                                Repeater{
                                    ...
                                    "用户x偏移","用户y偏移","用户z偏移",
                                    "用户x旋转偏移","用户y旋转偏移","用户z旋转偏移","过渡点","栈板长度","栈板宽度","像素转换世界比例"]
                            ...
                            TableView {
                                ...
                                model: TableModel {
                                    ...
                                    TableModelColumn { display: "palletLength" }
                                    TableModelColumn { display: "palletWidth" }
                                    TableModelColumn { display: "pixelScale" }
                                }
